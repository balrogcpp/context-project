...
option(ENABLE_AVX2 "ENABLE_AVX2" OFF)
...
if (CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    if (UNIX)
        if (ENABLE_SSE AND (CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "X86"))
            string(APPEND CMAKE_CXX_FLAGS " -msse4")
            string(APPEND CMAKE_C_FLAGS " -msse4")
        endif ()
        if (ENABLE_AVX2 AND CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
            string(APPEND CMAKE_CXX_FLAGS " -mavx2")
            string(APPEND CMAKE_C_FLAGS " -mavx2")
        endif ()
    elseif (WIN32)
        if (ENABLE_SSE AND (CMAKE_SYSTEM_PROCESSOR STREQUAL "AMD64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "X86"))
            string(APPEND CMAKE_CXX_FLAGS " -msse4")
            string(APPEND CMAKE_C_FLAGS " -msse4")
        endif ()
        if (ENABLE_AVX2 AND CMAKE_SYSTEM_PROCESSOR STREQUAL "AMD64")
            string(APPEND CMAKE_CXX_FLAGS " -mavx2")
            string(APPEND CMAKE_C_FLAGS " -mavx2")
        endif ()
    endif ()
