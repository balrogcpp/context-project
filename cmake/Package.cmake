...
macro(FlatZipDirectory curdir destination extention)
    ...
    find_program(TAR_EXE NAMES tar PATHS ENV PATH NO_DEFAULT_PATH)

    if (ZIP_EXE)
        execute_process(COMMAND ${CMAKE_COMMAND} -E chdir ${curdir} ${ZIP_EXE} -rq -D -X -9 -A ${destination}.${extention} ${filelist})
    elseif (WIN32 AND TAR_EXE)
        execute_process(COMMAND ${CMAKE_COMMAND} -E chdir ${curdir} ${TAR_EXE} caf ${destination}.${extention} ${filelist})
    else ()
