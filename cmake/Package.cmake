...
macro(FlatZipDirectory curdir destination)
    ...
    if (ZIP_EXE AND ZIP_VERSION VERSION_GREATER_EQUAL 3.0)
        ...
        #    elseif (Python3_FOUND AND Python3_VERSION VERSION_GREATER_EQUAL 3.2)
        #        get_filename_component(DEST_NAME ${destination} NAME_WLE)
        #        get_filename_component(DEST_PATH ${destination} DIRECTORY)
        #        message("Zip not found. Using python3 to archive assets")
        #        execute_process(COMMAND ${Python3_EXECUTABLE} -c "import shutil\nshutil.make_archive('${DEST_PATH}/${DEST_NAME}', 'zip', '${curdir}')")
