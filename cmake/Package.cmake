...
macro(FlatZipDirectory curdir destination)
    ...
    message("Using cmake ${CMAKE_VERSION} to archive assets")
    ...
    # CMake generates same output as libarchive bsdtar, with stipping tool is most sustainable way to create archive
    ...
    #        message("Using bsdtar ${TAR_VERSION} to archive assets")
...
if (STRIP_EXE)
    execute_process(COMMAND ${STRIP_EXE} --version OUTPUT_VARIABLE STRIP_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
    string(REGEX MATCH "nondeterminism version ([0-9/.]*)" _ "${STRIP_VERSION}")
    set(STRIP_VERSION ${CMAKE_MATCH_1})
    message("Using strip-nondeterminism ${STRIP_VERSION} to strip archive")
...
if (NOT EXISTS stripzip_app.c)
    file(WRITE stripzip_app.c
            ...
            "  size_t offset = 0;\n"
            "  while (offset < len) {\n"
            "    extra_header_t* hdr = (char*)extra_data + offset;\n"
            ...
            "        memset((char*)extra_data + offset, 0x00, hdr->length);\n"
            "        break;\n"
            "\n"
...
message("Using stripzip_app to strip archive")
