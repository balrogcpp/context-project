...
if (MSVC)
    set(TOOLCHAIN_FULL_NORMALISED "${CMAKE_SYSTEM_NAME}-${CMAKE_VS_PLATFORM_NAME}-${CMAKE_CXX_COMPILER_ID}")
else ()
    set(TOOLCHAIN_FULL_NORMALISED "${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}-${CMAKE_CXX_COMPILER_ID}")
endif ()

string(TOLOWER ${TOOLCHAIN_FULL_NORMALISED} TOOLCHAIN_FULL_NORMALISED)
message(${TOOLCHAIN_FULL_NORMALISED})
