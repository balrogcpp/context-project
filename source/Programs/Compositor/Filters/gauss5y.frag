...
vec3 Gauss5(sampler2D tex, const vec2 uv)
{
    ...
    vec3 B = texture2D(tex, uv + tsize * vec2(0.0, 1.3333333333333333)).xyz;
    vec3 C = texture2D(tex, uv - tsize * vec2(0.0, 1.3333333333333333)).xyz;
