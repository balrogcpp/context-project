...
mFadeInvisibleDist      (0.f)
{
   ...
   if (mRenderMethod == BB_METHOD_ACCELERATED)
   {
      ...
      if (s_nSelfInstances == 0)
      {
		 ...
		 HighLevelGpuProgramPtr vertexShader = HighLevelGpuProgramManager::getSingleton().getByName("Sprite_vp", Ogre::ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME);
		 ...
		 HighLevelGpuProgramPtr vertexShader2 = HighLevelGpuProgramManager::getSingleton().getByName("SpriteFade_vp", Ogre::ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME);
...
StaticBillboardSet::~StaticBillboardSet()
{
   if (mRenderMethod == BB_METHOD_ACCELERATED)
   {
      ...
      if (--s_nSelfInstances == 0)
      {
         ...
         HighLevelGpuProgramManager::getSingleton().remove("Sprite_vp", Ogre::ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME);
         HighLevelGpuProgramManager::getSingleton().remove("SpriteFade_vp", Ogre::ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME);
      }
   }
   else
