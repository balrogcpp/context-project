...
get_filename_component(PARENT_DIR ${INPUT} DIRECTORY ABSOLUTE)
file(GLOB_RECURSE filelist LIST_DIRECTORIES false RELATIVE ${PARENT_DIR} ${INPUT}/*)
message("Using cmake ${CMAKE_VERSION} to archive assets")
execute_process(COMMAND ${CMAKE_COMMAND} -E chdir ${PARENT_DIR} ${CMAKE_COMMAND} -E tar cf ${OUTPUT} --format=zip ${filelist})
...
if (NOT C_COMPILER)
    find_program(C_COMPILER NAMES cc gcc clang cl icc bcc32 bcc xlc)
endif ()
if (NOT C_COMPILER)
