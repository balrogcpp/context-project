...
find_path(OGRE_PROCEDURAL_DIR NAMES Procedural.h PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OgreProcedural")
...
if (OGRE_PROCEDURAL_DIR)
    list(APPEND OGRE_INCLUDE_DIRS ${OGRE_PROCEDURAL_DIR})
endif ()
