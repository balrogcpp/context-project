...
find_library(OGRE_PROCEDURAL_LIBRARY OgreProcedural${DEBUG_POSTFIX} PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OGRE")
find_path(OGRE_PROCEDURAL_INCLUDE_DIR NAMES Procedural.h PATHS ${OGRE_PREFIX_PATH} ${OGRE_INCLUDE_DIR} PATH_SUFFIXES "OgreProcedural")
find_library(OGRE_PAGED_GEOMETRY_LIBRARY PagedGeometry PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OGRE")
find_path(OGRE_PAGED_GEOMETRY_INCLUDE_DIR NAMES PagedGeometry.h PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "PagedGeometry")
find_library(OGRE_OGGSOUND_LIBRARY OgreOggSound${DEBUG_POSTFIX} PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OGRE")
find_path(OGRE_OGGSOUND_INCLUDE_DIR NAMES OgreOggSound.h PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OGRE")
find_library(OGRE_THEORA_LIBRARY Plugin_TheoraVideoSystem${DEBUG_POSTFIX} PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OGRE")
find_library(OGRE_THEORA_PLAYER_LIBRARY theoraplayer${DEBUG_POSTFIX} PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OGRE")
find_path(OGRE_THEORA_INCLUDE_DIR NAMES OgreVideoManager.h PATHS ${OGRE_PREFIX_PATH} PATH_SUFFIXES "OGRE")
...
if (OGRE_PROCEDURAL_LIBRARY)
    list(APPEND OGRE_LIBRARIES ${OGRE_PROCEDURAL_LIBRARY})
endif ()
if (OGRE_PROCEDURAL_INCLUDE_DIR)
    list(APPEND OGRE_INCLUDE_DIRS ${OGRE_PROCEDURAL_INCLUDE_DIR})
endif ()
if (OGRE_PAGED_GEOMETRY_LIBRARY)
    list(APPEND OGRE_LIBRARIES ${OGRE_PAGED_GEOMETRY_LIBRARY})
endif ()
if (OGRE_PAGED_GEOMETRY_INCLUDE_DIR)
    list(APPEND OGRE_INCLUDE_DIRS ${OGRE_PAGED_GEOMETRY_INCLUDE_DIR})
endif ()
if (OGRE_OGGSOUND_LIBRARY)
    find_package(OpenAL)
    find_package_static(Ogg)
    find_package_static(Vorbis)
    if (Vorbis_FOUND)
        list(APPEND OGRE_LIBRARIES ${VORBIS_LIBRARIES})
        list(APPEND OGRE_LIBRARIES ${VORBIS_INCLUDE_DIRS})
    endif ()
    if (Ogg_FOUND)
        list(APPEND OGRE_LIBRARIES ${OGG_LIBRARIES})
        list(APPEND OGRE_LIBRARIES ${OGG_INCLUDE_DIRS})
    endif ()
    if (OpenAL_FOUND)
        list(APPEND OGRE_LIBRARIES ${OPENAL_LIBRARY})
        list(APPEND OGRE_LIBRARIES ${OPENAL_INCLUDE_DIR})
    endif ()
    list(APPEND OGRE_LIBRARIES ${OGRE_OGGSOUND_LIBRARY})
endif ()
if (OGRE_OGGSOUND_INCLUDE_DIR)
    list(APPEND OGRE_INCLUDE_DIRS ${OGRE_OGGSOUND_INCLUDE_DIR})
endif ()
if (OGRE_THEORA_LIBRARY)
    find_package_static(Theora)
    if (Theora_FOUND)
        list(APPEND OGRE_LIBRARIES ${THEORA_LIBRARY})
    endif ()
    list(APPEND OGRE_LIBRARIES ${OGRE_THEORA_PLAYER_LIBRARY} ${OGRE_THEORA_LIBRARY})
    list(APPEND OGRE_INCLUDE_DIRS ${OGRE_INCLUDE_DIR}/Plugins/Theora)
endif ()
...
if (OGRE_MAIN_LIBRARY)
    ...
    if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
        list(APPEND OGRE_LIBRARIES dl X11 Xrandr)
    elseif (MINGW)
...
if (OGRE_GLS_LIBRARY)
    ...
    if (CMAKE_FIND_USE_CMAKE_SYSTEM_PATH)
...
mark_as_advanced(OGRE_PROCEDURAL_LIBRARY)
mark_as_advanced(OGRE_PROCEDURAL_INCLUDE_DIR)
mark_as_advanced(OGRE_PAGED_GEOMETRY_LIBRARY)
mark_as_advanced(OGRE_PAGED_GEOMETRY_INCLUDE_DIR)
mark_as_advanced(OGRE_OGGSOUND_LIBRARY)
mark_as_advanced(OGRE_OGGSOUND_INCLUDE_DIR)
mark_as_advanced(OGRE_THEORA_LIBRARY)
mark_as_advanced(OGRE_THEORA_PLAYER_LIBRARY)
mark_as_advanced(OGRE_THEORA_INCLUDE_DIR)
