...
if (SDL2_FOUND)
    ...
    list(APPEND GLUE_INCLUDE_DIRS ${SDL2_INCLUDE_DIR})
endif ()
if (pugixml_FOUND)
    list(APPEND GLUE_LINK_LIBRARIES ${PUGIXML_LIBRARY})
    list(APPEND GLUE_INCLUDE_DIRS ${PUGIXML_INCLUDE_DIR})
endif ()
if (Bullet_FOUND)
...
if (Vorbis_FOUND)
    ...
    list(APPEND GLUE_INCLUDE_DIRS ${VORBIS_INCLUDE_DIR})
endif ()
if (Ogg_FOUND)
    list(APPEND GLUE_LINK_LIBRARIES ${OGG_LIBRARIES})
    list(APPEND GLUE_INCLUDE_DIRS ${OGG_INCLUDE_DIR})
endif ()
if (OpenAL_FOUND)
