...
if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR (CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND NOT MSVC))
    ...
    elseif (${CMAKE_BUILD_TYPE_LOWER} MATCHES "rel")
        ...
        string(APPEND CMAKE_CXX_FLAGS " -funroll-loops -ffast-math")
    endif ()
    ...
    if (UNIX)
        if (CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "AMD64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "X86")
            if (USE_AVX2)
                ...
                string(APPEND CMAKE_CXX_FLAGS " -ftree-vectorize -msse4.2")
            endif()
        endif ()
    endif ()
...
elseif (MSVC)
    ...
    if (CMAKE_SYSTEM_PROCESSOR STREQUAL "AMD64" OR CMAKE_SYSTEM_PROCESSOR STREQUAL "X86")
        if (USE_AVX2)
            ...
            string(APPEND CMAKE_CXX_FLAGS " /d2archSSE42")
        endif ()
