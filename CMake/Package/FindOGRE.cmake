set(OGRE_INCLUDE_DIRS /home/andrew/source/context-project/ThirdParty/External/Linux_x86_64_Clang_Release/sdk/include/OGRE)
...
find_library(OGRE_MAIN_LIBRARY OgreMain${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_MESHLOD_LIBRARY OgreMeshLodGenerator${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_OVERLAY_LIBRARY OgreOverlay${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_PAGING_LIBRARY OgrePaging${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_RTSS_LIBRARY OgreRTShaderSystem${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_TERRAIN_LIBRARY OgreTerrain${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_VOLUME_LIBRARY OgreVolume${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_OCTREE_LIBRARY Plugin_OctreeSceneManager${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_PFX_LIBRARY Plugin_ParticleFX${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_GL3_LIBRARY RenderSystem_GL3Plus${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_GLES2_LIBRARY RenderSystem_GLES2${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_STBI_LIBRARY Codec_STBI${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
find_library(OGRE_GLS_LIBRARY OgreGLSupport${OGRE_POSTFIX} ${GLUE_EXTERNAL_LIB_DIR}/OGRE)
...
if (OGRE_DOTSCENE_LIBRARY)
    list(APPEND OGRE_LIBRARIES pugixml ${OGRE_DOTSCENE_LIBRARY})
endif ()
...
if (OGRE_OVERLAY_LIBRARY)
    ...
    list(APPEND OGRE_LIBRARIES freetype ${OGRE_OVERLAY_LIBRARY})
endif ()
...
if (OGRE_GLES2_LIBRARY)
    ...
    list(APPEND OGRE_LIBRARIES ${OPENGLES2_LIBRARY} OpenGL::EGL ${OGRE_GLES2_LIBRARY})
endif ()
...
if (OGRE_MAIN_LIBRARY)
    find_package(ZLIB)
    list(APPEND OGRE_LIBRARIES ${ZLIB_LIBRARIES} ${OGRE_MAIN_LIBRARY})
endif ()
