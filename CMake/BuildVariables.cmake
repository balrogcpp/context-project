...
add_external_package_static(fmt)
...
if (Theora_FOUND)
    list(APPEND ENGINE_LIBRARIES ${THEORA_LIBRARY})
    list(APPEND ENGINE_INCLUDE_DIRS ${THEORA_INCLUDE_DIR})
endif ()
if (Vorbis_FOUND)
...
if (fmt_FOUND)
    list(APPEND ENGINE_LIBRARIES fmt::fmt)
endif ()
